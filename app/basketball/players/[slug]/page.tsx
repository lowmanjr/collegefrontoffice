...
export default async function BasketballPlayerProfilePage({ params }: PageProps) {
  ...
  const heroDraftLabel =
    p.player_tag !== "High School Recruit"
      ? formatDraftProjectionBadge(p.nba_draft_projection)
      : null;
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="mb-2 flex flex-wrap gap-2">
                ...
                {p.role_tier && (
                  <span className={roleTierBadgeClass(p.role_tier, "dark")}>
                    {roleTierLabel(p.role_tier)}
                  </span>
                )}
                {heroDraftLabel && (
                  <span className="rounded px-2.5 py-0.5 text-xs font-semibold uppercase tracking-widest bg-purple-500 text-white">
                    {heroDraftLabel}
                  </span>
                )}
              </div>
      ...
      <div className="mx-auto max-w-3xl px-6 py-4 space-y-4">
        ...
        {!isPrivate && displayValuation != null && !hasOverrideData && (
          <div className="flex items-center gap-2 text-xs text-slate-400">
            ...
            <p>
              This valuation is generated by our proprietary basketball valuation engine
