...
export default async function OGImage(props: { params: Promise<{ slug: string }> }) {
  ...
  const { data: player } = await supabase
    ...
    .select("name, position, star_rating, cfo_valuation, player_tag, is_public, basketball_teams(university_name)")
    .eq("slug", slug)
    .single();
  ...
  const team = player.basketball_teams as unknown as { university_name: string } | null;
